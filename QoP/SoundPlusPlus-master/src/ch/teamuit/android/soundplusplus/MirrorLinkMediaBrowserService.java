...
public class MirrorLinkMediaBrowserService extends MediaBrowserService
	...
	private static final String CUSTOM_ACTION_REPEAT = "ch.teamuit.android.soundplusplus.REPEAT";
	// Action to change the repeat mode
	private static final String CUSTOM_ACTION_SHUFFLE = "ch.teamuit.android.soundplusplus.SHUFFLE";
		...
		mMediaRoot.add(new MediaBrowser.MediaItem(
				new MediaDescription.Builder()
					...
					.setIconUri(Uri.parse("android.resource://" +
							"ch.teamuit.android.soundplusplus/drawable/ic_menu_music_library"))
